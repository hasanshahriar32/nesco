...
const Footer = () => {
  ...
  return (
    <div className="btm-nav text-warning">
      <button onClick={() => RedirectCall("/")}>
        <svg
      ...
      <button className="active" onClick={() => RedirectCall("/bill")}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
          fill="none"
      ...
      <button onClick={() => RedirectCall("/bill/history")}>
        ...
        <span className="btm-nav-label hidden md:block">ইতিহাস</span>
      </button>
    </div>
  );
};
